...
public class DodawanieDanych extends javax.swing.JDialog {
     ...
     */
    public DodawanieDanych(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        
        jTextFieldImie.setText("");
        jTextFieldNazwisko.setText("");
        jTextFieldKlasa.setText("");
        jTextFieldRokRozpoczeciaNauki.setText("");
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DodawanieDanych.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                DodawanieDanych dialog = new DodawanieDanych(new javax.swing.JFrame(), true);
